defmodule Explorer.Chain.ValidatorStability do
  ...
  @primary_key false
  schema "validators_stability" do
    field(:address_hash, HashAddress, primary_key: true)
    field(:state, Ecto.Enum, values: [active: 0, probation: 1, inactive: 2])
  ...
  # def fetch_active_validators_list() do
  #   params = %{@get_active_validator_list_method_id => []}

  #   call_contract(@get_active_validator_list_abi, params, @get_active_validator_list_method_id)
  # end

  # def fetch_validators_list() do
  #   params = %{@get_validator_list_method_id => []}

  #   call_contract(@get_validator_list_abi, params, @get_validator_list_method_id)
  # end
  ...
  def fetch_validators_lists() do
    ...
    case Reader.query_contract(@stability_validator_controller_contract, abi, params, false) do
      ...
      error ->
        Logger.warn(fn -> ["Error on getting validator lists: #{error}"] end)
        nil
    end
  end
  ...
  # defp call_contract(abi, params, method_id) do
  #   abi = [abi]
